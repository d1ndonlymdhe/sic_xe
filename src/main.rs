...
impl Constant {
    fn new_string(value: String) -> Constant {
        Constant {
            variant: ConstantVariant::STRING,
            str_value: value,
            hex_value: 0,
        }
    }
    fn new_hex(value: u32) -> Constant {
        Constant {
            variant: ConstantVariant::HEX,
    ...
    fn get_string(self) -> String {
        match self.variant {
            ConstantVariant::STRING => self.str_value,
            ConstantVariant::HEX => panic!("Constant is not a string"),
        }
    }
    fn get_hex(self) -> u32 {
        match self.variant {
            ConstantVariant::STRING => panic!("Constant is not a hex"),
            ConstantVariant::HEX => self.hex_value,
        }
    }
}
